...
def prepare_gastric_EBV_data_json(fold=0, split_type='V0', colornorm=False):
    ...
    if colornorm:
        data_root_dir_wsi = '/data1/trinh/data/patch_data/KBSMC/gastric/EBV/Gastric_EBV_1024/Gastric_WSI/gastric_wsi_1024_08_resize05_MacenkoNormed/'
        data_root_dir = '/data1/trinh/data/patch_data/KBSMC/gastric/EBV/Gastric_EBV_1024/Gastric_TMAs/Gastric_EBV_V2_1024/tma_image_resize05_MacenkoNormed/'
    else:
        data_root_dir_wsi = '/data1/trinh/data/patch_data/KBSMC/gastric/EBV/Gastric_EBV_1024/Gastric_WSI/gastric_wsi_1024_08_resize05/'
        data_root_dir = '/data1/trinh/data/patch_data/KBSMC/gastric/EBV/Gastric_EBV_1024/Gastric_TMAs/Gastric_EBV_V2_1024/core_image_resize05/'
